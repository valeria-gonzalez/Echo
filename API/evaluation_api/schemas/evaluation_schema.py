...
class AnalysisResponse(BaseModel):
    number_of_syllables: Optional[int] = Field(
        None,
        description="Number of syllables identified during speech.",
        example=30
    )
    number_of_pauses: Optional[int] = Field(
        None,
        description="Number of pauses identified during speech.",
        example=5
    )
    speech_rate: Optional[float] = Field(
        None,
        description="Number of syllables spoken per second (including pauses and fillers).",
        example=5
    )
    articulation_rate: Optional[float] = Field(
        None,
        description="Number of syllables spoken per second (excluding pauses and fillers).",
        example=5
    )
    speaking_duration: Optional[float] = Field(
        None,
        description="Speaking time in seconds (excluding fillers and pauses).",
        example=5
    )
    total_duration: Optional[float] = Field(
        None,
        description="Speaking time in seconds (including fillers and pauses)",
        example=5
    )
    ratio: Optional[float] = Field(
        None,
        description="Ratio between speaking duration and total speaking duration.",
        example=5
    )
    transcription: Optional[str] = Field(
        None,
        description="Transcription generated from speech.",
        example=5
    )
